            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="card card-profile">
                  <div class="card-header" style="background-image: url(tabler/demo/photos/eberhard-grossgasteiger-311213-500.jpg);"></div>
                  <div class="card-body text-center">
                    <img class="card-profile-img" src="tabler/demo/faces/male/16.jpg">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="media">
                      <span class="avatar avatar-xxl mr-5" style="background-image: url(tabler/demo/faces/male/21.jpg)"></span>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-xl" style="background-image: url(tabler/demo/faces/female/9.jpg)"></span>
                        </div>
                        <div class="col">
                ...
                <div class="card">
                  ...
                  <ul class="list-group card-list-group">
                    <li class="list-group-item py-5">
                      <div class="media">
                        <div class="media-object avatar avatar-md mr-4" style="background-image: url(tabler/demo/faces/male/16.jpg)"></div>
                        <div class="media-body">
                          ...
                          <ul class="media-list">
                            <li class="media mt-4">
                              <div class="media-object avatar mr-4" style="background-image: url(tabler/demo/faces/female/17.jpg)"></div>
                              <div class="media-body">
                            ...
                            <li class="media mt-4">
                              <div class="media-object avatar mr-4" style="background-image: url(tabler/demo/faces/male/32.jpg)"></div>
                              <div class="media-body">
                    ...
                    <li class="list-group-item py-5">
                      <div class="media">
                        ...
                        <div class="media-body">
                          ...
                          <ul class="media-list">
                            <li class="media mt-4">
                              <div class="media-object avatar mr-4" style="background-image: url(tabler/demo/faces/male/26.jpg)"></div>
                              <div class="media-body">
