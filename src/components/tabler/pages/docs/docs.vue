        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 order-lg-1 mb-4">
                    ...
                    <a href="../docs/colors.html" class="list-group-item list-group-item-action active"><span class="icon mr-3"><i class="fe fe-feather"></i></span>Colors</a>
                    ...
                    <a href="https://github.com/tabler/tabler/edit/dev/src/_docs/colors.md" class="text-muted">Edit this page</a>
                    </div>
                </div>
                <div class="col-lg-9">
