            ...
            <div class="row row-cards">
                ...
                <div class="col-lg-9">
                    ...
                    <table class="table card-table table-vcenter">
                        <tr>
                        <td><img src="tabler/demo/products/apple-iphone7-special.jpg" alt="" class="h-8"></td>
                        <td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/apple-macbook-pro.jpg" alt="" class="h-8"></td>
                        <td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/apple-iphone7.jpg" alt="" class="h-8"></td>
                        <td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/gopro-hero.jpg" alt="" class="h-8"></td>
                        <td>
                            GoPro HERO6 Black
                            <div class="badge badge-default badge-md">New</div>
                        </td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/msi.jpg" alt="" class="h-8"></td>
                        <td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/xiaomi-mi.jpg" alt="" class="h-8"></td>
                        <td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/huawei-mate.jpg" alt="" class="h-8"></td>
                        <td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/sony-kd.jpg" alt="" class="h-8"></td>
                        <td>
                            Sony KD-49XE7005
                            <div class="badge badge-default badge-md">New</div>
                        </td>
                        ...
                        <tr>
                        <td><img src="tabler/demo/products/samsung-galaxy.jpg" alt="" class="h-8"></td>
                        <td>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                <img src="tabler/demo/products/apple-iphone7-special.jpg" alt="Apple iPhone 7 128GB" class="img-fluid">
                                </div>
                        ...
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="mb-4 text-center">
                                    <img src="tabler/demo/products/gopro-hero.jpg" alt="Apple iPhone 7 128GB" class="img-fluid">
                                </div>
